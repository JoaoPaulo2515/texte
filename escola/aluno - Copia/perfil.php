...
$sql_aluno = "SELECT e.*, 
                     ...
                     es.whatsapp as escola_whatsapp
              FROM estudantes e
...
// Buscar estatísticas (sem ocorrencias)
$sql_stats = "SELECT 
                COUNT(DISTINCT m.id) as total_matriculas,
                COUNT(DISTINCT p.id) as total_pagamentos,
                COALESCE(SUM(p.valor), 0) as total_pago,
                COUNT(DISTINCT t.id) as total_tarefas,
                COUNT(DISTINCT CASE WHEN r.id IS NOT NULL THEN t.id END) as total_entregues,
...
$sql_notificacoes = "SELECT COUNT(*) as total_nao_lidas
                     FROM notificacoes_aluno
                     WHERE aluno_id = :aluno_id AND lida = 0";
$stmt_notificacoes = $conn->prepare($sql_notificacoes);
$stmt_notificacoes->execute([':aluno_id' => $aluno_id]);
$notificacoes = $stmt_notificacoes->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stat-box">
                    ...
                    <div class="stat-number"><?php echo $stats['total_entregues'] ?? 0; ?></div>
                    <div>Entregues</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo htmlspecialchars($aluno['provincia'] ?? 'Luanda'); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="info-card">
                    ...
                    <?php if ($aluno['escola_whatsapp']): ?>
                    <div class="info-row">
                        <span class="info-label">WhatsApp:</span>
                        <span class="info-value">
                            <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $aluno['escola_whatsapp']); ?>" target="_blank" class="whatsapp-link">
                                <i class="fab fa-whatsapp"></i> <?php echo $aluno['escola_whatsapp']; ?>
                            </a>
                        </span>
                    </div>
                    <?php endif; ?>
                                    ...
                                    <tr class="tarefa-item">
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($tarefa['resposta_status'] == 'entregue'): ?>
                                                <span class="badge bg-warning text-dark">Entregue</span>
                                            <?php else: ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="p-3 border rounded">
                                    ...
                                    <small class="text-muted">(<?php echo ucfirst($responsavel['parentesco']); ?>)</small>
                                    <div class="mt-2">
                                        ...
                                        <?php if ($responsavel['bi']): ?>
                                        <div><i class="fas fa-id-card"></i> BI: <?php echo $responsavel['bi']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control" name="telefone" value="<?php echo $aluno['telefone'] ?? ''; ?>" placeholder="923456789">
                                <small class="text-muted">Formato: 9xx xxx xxx</small>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="provincia">
                                    <option value="Luanda" <?php echo ($aluno['provincia'] ?? '') == 'Luanda' ? 'selected' : ''; ?>>Luanda</option>
                                    <option value="Benguela" <?php echo ($aluno['provincia'] ?? '') == 'Benguela' ? 'selected' : ''; ?>>Benguela</option>
                                    <option value="Huíla" <?php echo ($aluno['provincia'] ?? '') == 'Huíla' ? 'selected' : ''; ?>>Huíla</option>
                                    <option value="Bié" <?php echo ($aluno['provincia'] ?? '') == 'Bié' ? 'selected' : ''; ?>>Bié</option>
                                    <option value="Cabinda" <?php echo ($aluno['provincia'] ?? '') == 'Cabinda' ? 'selected' : ''; ?>>Cabinda</option>
                                    <option value="Cuando Cubango" <?php echo ($aluno['provincia'] ?? '') == 'Cuando Cubango' ? 'selected' : ''; ?>>Cuando Cubango</option>
                                    <option value="Cuanza Norte" <?php echo ($aluno['provincia'] ?? '') == 'Cuanza Norte' ? 'selected' : ''; ?>>Cuanza Norte</option>
                                    <option value="Cuanza Sul" <?php echo ($aluno['provincia'] ?? '') == 'Cuanza Sul' ? 'selected' : ''; ?>>Cuanza Sul</option>
                                    <option value="Cunene" <?php echo ($aluno['provincia'] ?? '') == 'Cunene' ? 'selected' : ''; ?>>Cunene</option>
                                    <option value="Huambo" <?php echo ($aluno['provincia'] ?? '') == 'Huambo' ? 'selected' : ''; ?>>Huambo</option>
                                    <option value="Lunda Norte" <?php echo ($aluno['provincia'] ?? '') == 'Lunda Norte' ? 'selected' : ''; ?>>Lunda Norte</option>
                                    <option value="Lunda Sul" <?php echo ($aluno['provincia'] ?? '') == 'Lunda Sul' ? 'selected' : ''; ?>>Lunda Sul</option>
                                    <option value="Malanje" <?php echo ($aluno['provincia'] ?? '') == 'Malanje' ? 'selected' : ''; ?>>Malanje</option>
                                    <option value="Moxico" <?php echo ($aluno['provincia'] ?? '') == 'Moxico' ? 'selected' : ''; ?>>Moxico</option>
                                    <option value="Namibe" <?php echo ($aluno['provincia'] ?? '') == 'Namibe' ? 'selected' : ''; ?>>Namibe</option>
                                    <option value="Uíge" <?php echo ($aluno['provincia'] ?? '') == 'Uíge' ? 'selected' : ''; ?>>Uíge</option>
                                    <option value="Zaire" <?php echo ($aluno['provincia'] ?? '') == 'Zaire' ? 'selected' : ''; ?>>Zaire</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
