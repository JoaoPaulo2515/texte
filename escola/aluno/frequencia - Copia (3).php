...
// Se não houver filtro de ano, usa o ano atual
...
// Buscar TODOS os anos letivos disponíveis (da tabela periodo_letivo)
...
if (empty($anos_disponiveis)) {
    // Fallback: buscar da tabela chamada
...
// Se o ano atual não estiver na lista de anos disponíveis, adiciona ele
...
// Buscar frequências do aluno usando a tabela chamada
...
foreach ($frequencias_por_disciplina as $disciplina => $dados) {
    ...
    // Percentual geral da disciplina
        ...
        <div class="modal-ajuda-body">
            <div class="ajuda-item">
                ...
                <div class="ajuda-texto">
                    Esta página exibe o registro de sua frequência escolar, mostrando presenças, faltas, justificativas e atrasos por disciplina.
                </div>
            </div>
            ...
            <div class="ajuda-item">
                ...
                <div class="ajuda-texto">
                    <span class="badge bg-success">Presente</span> - Aluno compareceu à aula<br>
                    <span class="badge bg-danger">Ausente</span> - Aluno não compareceu<br>
                    <span class="badge badge-justificado">Justificado</span> - Falta justificada<br>
                    <span class="badge badge-atrasado">Atrasado</span> - Aluno chegou atrasado
                </div>
            </div>
            ...
            <div class="ajuda-item">
                ...
                <div class="ajuda-texto">
                    Utilize os filtros de ano letivo, bimestre e disciplina para visualizar períodos específicos.
                </div>
            </div>
        </div>
    </div>
...
<div class="main-content-aluno">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <h6 class="mb-0 <?php echo $percentual_geral >= 75 ? 'text-success' : ($percentual_geral >= 50 ? 'text-warning' : 'text-danger'); ?>">
            ...
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="bimestre" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="<?php echo $bim; ?>" <?php echo $bimestre_filtro == $bim ? 'selected' : ''; ?>>
                            <?php echo $bim; ?>º Bimestre
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <a href="frequencia.php" class="btn btn-outline-secondary w-100">
    ...
    <div class="row g-3 mb-4 fade-in">
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-label"><i class="fas fa-check-circle text-success"></i> Presenças</div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="stat-card">
                <div class="stat-value text-danger"><?php echo $total_ausencias_geral; ?></div>
                <div class="stat-label"><i class="fas fa-times-circle text-danger"></i> Faltas</div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="stat-card">
                <div class="stat-value text-info"><?php echo $total_justificados_geral; ?></div>
                <div class="stat-label"><i class="fas fa-file-alt text-info"></i> Justificadas</div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="stat-card">
                <div class="stat-value text-warning"><?php echo $total_atrasos_geral; ?></div>
                <div class="stat-label"><i class="fas fa-clock text-warning"></i> Atrasos</div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm fade-in">
        <div class="card-header bg-white fw-bold">
            ...
            <span class="badge bg-primary ms-2">Disciplina filtrada</span>
            <?php endif; ?>
        </div>
        <div class="card-body">
                    ...
                    <table class="table table-bordered table-frequencia">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th rowspan="2" class="text-center">Justif.</th>
                                <th rowspan="2" class="text-center">Atrasos</th>
                        ...
                        <tbody>
                            <?php foreach ($frequencias_por_disciplina as $disciplina => $dados): 
                                $cor_percentual = getCorPercentual($dados['percentual_geral']);
                            ?>
                            <tr>
                                ...
                                <?php for ($mes = 1; $mes <= 12; $mes++): 
                                    ...
                                    $presencas = $mes_dado ? $mes_dado['presente'] : '-';
                                    $ausencias = $mes_dado ? $mes_dado['ausente'] : '-';
                                    $justificados = $mes_dado ? $mes_dado['justificado'] : '-';
                                    $atrasos = $mes_dado ? $mes_dado['atrasado'] : '-';
                                ?>
                                <td class="text-center"><?php echo $presencas !== '-' ? $presencas : '-'; ?></td>
                                <td class="text-center"><?php echo $ausencias !== '-' ? $ausencias : '-'; ?></td>
                                <td class="text-center"><?php echo $justificados !== '-' ? $justificados : '-'; ?></td>
                                <td class="text-center"><?php echo $atrasos !== '-' ? $atrasos : '-'; ?></td>
                                <?php endfor; ?>
                                ...
                                <td class="text-center fw-bold" style="color: <?php echo $cor_percentual; ?>;">
                                    <?php echo number_format($dados['percentual_geral'], 1, ',', '.'); ?>%
                                </td>
    ...
    <div class="card border-0 shadow-sm mt-4 fade-in">
        <div class="card-header bg-white fw-bold">
            <i class="fas fa-chart-pie"></i> Resumo por Bimestre (1º, 2º e 3º)
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th colspan="4" class="text-center"><?php echo $bim; ?>º Bimestre</th>
                            <?php endfor; ?>
                        </tr>
                        <tr class="table-light">
                            <th></th>
                            <?php for ($bim = 1; $bim <= 3; $bim++): ?>
                            <th>P</th><th>F</th><th>%</th><th>Status</th>
                            <?php endfor; ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?php echo htmlspecialchars($disciplina); ?></strong></td>
                            <?php for ($bim = 1; $bim <= 3; $bim++): 
                                $bim_dado = isset($dados['bimestres'][$bim]) ? $dados['bimestres'][$bim] : null;
                                $presencas = $bim_dado ? $bim_dado['presente'] : 0;
                                $ausencias = $bim_dado ? $bim_dado['ausente'] : 0;
                                $percentual = $bim_dado ? $bim_dado['percentual'] : 0;
                                $status_bim = getStatusFrequencia($percentual);
                            ?>
                            <td class="text-center"><?php echo $presencas; ?></td>
                            <td class="text-center"><?php echo $ausencias; ?></td>
                            <td class="text-center <?php echo $percentual >= 75 ? 'text-success' : ($percentual >= 50 ? 'text-warning' : 'text-danger'); ?>">
                                <?php echo number_format($percentual, 1, ',', '.'); ?>%
                            </td>
                            <td class="text-center"><?php echo $status_bim; ?></td>
                            <?php endfor; ?>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span><strong>Regular:</strong> ≥ 75%</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                ...
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span><strong>Irregular:</strong> &lt; 50%</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="d-flex align-items-center gap-2">
                        <span class="badge bg-info">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <span><strong>Justificado</strong></span>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-12">
                    <small class="text-muted">
                        <i class="fas fa-info-circle"></i> P = Presente | F = Falta | J = Justificado | A = Atraso
                    </small>
                </div>
            </div>
        </div>
