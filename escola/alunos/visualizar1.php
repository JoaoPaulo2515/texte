...
$stmt = $conn->prepare("
    SELECT e.*, u.nome, u.email as usuario_email, u.telefone as usuario_telefone,
           t.nome as turma_nome, m.status as matricula_status, m.data_matricula
    FROM estudantes e
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="index.php" class="nav-link active"><i class="fas fa-users"></i> Alunos</a></li>
