...
if (!in_array($_SESSION['usuario_tipo'], ['super_admin', 'admin_escola'])) {
...
if (isset($_GET['testar_email']) && isset($_GET['email'])) {
   ...
   $caminho = __DIR__ . '/../../../vendor/autoload.php';
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <div style="padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Escola: ' . $_SESSION['escola_nome'] . '</li>
                    </ul>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="from_name" class="form-control" value="<?php echo htmlspecialchars($config['from_name'] ?: $_SESSION['escola_nome']); ?>" required>
                                    </div>
                                    <div class="mb-3">
