<?php
// escola/financeiro/contas_pagar/adicionar.php - Adicionar Conta a Pagar
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("
        INSERT INTO escola_contas_pagar 
        (escola_id, fornecedor, documento, descricao, valor, valor_pago, data_emissao, data_vencimento, 
         categoria, parcela, total_parcelas, status, observacoes, usuario_id)
        VALUES 
        (:escola_id, :fornecedor, :documento, :descricao, :valor, 0, :data_emissao, :data_vencimento,
         :categoria, :parcela, :total_parcelas, 'pendente', :observacoes, :usuario_id)
    ");
    $stmt->execute([
        ':escola_id' => $escola_id,
    ...
    $_SESSION['mensagem'] = "Conta a pagar adicionada com sucesso!";
...
<head>
    ...
    <title>Adicionar Conta a Pagar | SIGE Angola</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar"><h2><i class="fas fa-plus"></i> Nova Conta a Pagar</h2><a href="index.php" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Voltar</a></div>
        
        <div class="card">
            <div class="card-header bg-primary text-white"><i class="fas fa-edit"></i> Formulário de Cadastro</div>
            <div class="card-body">
                <form method="POST">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="required">Fornecedor</label>
                            <input type="text" name="fornecedor" class="form-control" required placeholder="Nome do fornecedor">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Documento/Nº</label>
                            <input type="text" name="documento" class="form-control" placeholder="Ex: Nota Fiscal, Contrato">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="required">Descrição</label>
                        <textarea name="descricao" class="form-control" rows="2" required placeholder="Descreva o motivo da despesa..."></textarea>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label>Parcela</label>
                            <input type="number" name="parcela" class="form-control" value="1" min="1">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Total de Parcelas</label>
                            <input type="number" name="total_parcelas" class="form-control" value="1" min="1">
                        </div>
                    </div>
                    <div class="mb-3">
