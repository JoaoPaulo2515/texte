<?php
// escola/financeiro/contas_receber/adicionar.php - Adicionar Conta a Receber
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("
        INSERT INTO escola_contas_receber 
        (escola_id, aluno_id, documento, descricao, valor, valor_recebido, data_emissao, data_vencimento, 
         parcela, total_parcelas, status, observacoes, usuario_id)
        VALUES 
        (:escola_id, :aluno_id, :documento, :descricao, :valor, 0, :data_emissao, :data_vencimento,
         :parcela, :total_parcelas, 'pendente', :observacoes, :usuario_id)
    ");
    $stmt->execute([
        ':escola_id' => $escola_id,
        ':aluno_id' => $aluno_id,
...
<head>
    ...
    <title>Adicionar Conta a Receber | SIGE Angola</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar"><h2><i class="fas fa-plus"></i> Nova Conta a Receber</h2><a href="index.php" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Voltar</a></div>
                ...
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="documento" class="form-control" placeholder="Ex: Nota Fiscal, Recibo, Contrato">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="required">Descrição</label>
                        <textarea name="descricao" class="form-control" rows="2" required placeholder="Descreva o motivo da cobrança..."></textarea>
                    </div>
                    <div class="row">
