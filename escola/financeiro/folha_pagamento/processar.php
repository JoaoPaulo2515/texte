    ...
    <script>
        ...
        function carregarFuncionarios() {
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        if (data.funcionarios.length === 0) {
                            $('#tbodyFuncionarios').html('<tr><td colspan="10" class="text-center text-muted">Nenhum funcionário adicionado<\/td><\/tr>');
                            $('#tfootFuncionarios').hide();
                            return;
                        }
                ...
                error: function() {
                    $('#tbodyFuncionarios').html('<tr><td colspan="10" class="text-center text-danger">Erro ao carregar funcionários<\/td><\/tr>');
                }
            });
        }
        ...
        function carregarFuncionariosDisponiveis() {
            ...
            $.ajax({
                ...
                error: function() {
                    $('#tbodyFuncionariosDisponiveis').html('<td><td colspan="5" class="text-center text-danger">Erro ao carregar funcionários<\/td><\/tr>');
                }
            });
        }
        ...
        function removerFalta(faltaId, funcionarioId) {
