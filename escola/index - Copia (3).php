...
<head>
    ...
    <script src="../assets/js/jquery1-3.6.0.min.js"></script>
...
<body>
    ...
    <script>
        ...
        if (currentPage.includes('/rh/')) {
            $('#menuRH').addClass('open'); $('#submenuRH').addClass('show');
            if (currentPage.includes('funcionarios')) { $('#menuRHFuncionarios').addClass('open'); $('#submenuRHFuncionarios').addClass('show'); }
            if (currentPage.includes('recrutamento')) { $('#menuRHRecrutamento').addClass('open'); $('#submenuRHRecrutamento').addClass('show'); }
            if (currentPage.includes('avaliacao')) { $('#menuRHAvaliacao').addClass('open'); $('#submenuRHAvaliacao').addClass('show'); }
        }
        ...
        if (currentPage.includes('folha_pagamento')) { $('#submenuFolhaPagamento').addClass('show'); }
