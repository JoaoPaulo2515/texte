...
<body>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item has-submenu" id="menuFinanceiro">
                ...
                <ul class="nav-submenu" id="submenuFinanceiro">
                    ...
                    <!-- Folha de Pagamento (NOVO) -->
                    <li class="nav-item has-submenu" id="submenuFolhaPagamento">
                        <a href="#" class="nav-link" onclick="toggleSubmenu(event)">
                            <i class="fas fa-file-invoice-dollar"></i> Folha de Pagamento
                        </a>
                        <ul class="nav-submenu" id="submenuFolhaPagamentoItens">
                            <li class="nav-item"><a href="financeiro/folha_pagamento/index.php" class="nav-link"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/funcionarios.php" class="nav-link"><i class="fas fa-users"></i> Funcionários</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/cargos.php" class="nav-link"><i class="fas fa-briefcase"></i> Cargos</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/processar.php" class="nav-link"><i class="fas fa-calculator"></i> Processar Folha</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/holerites.php" class="nav-link"><i class="fas fa-receipt"></i> Holerites</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/relatorios.php" class="nav-link"><i class="fas fa-chart-line"></i> Relatórios</a></li>
                            <li class="nav-item"><a href="financeiro/folha_pagamento/configuracoes.php" class="nav-link"><i class="fas fa-cog"></i> Configurações</a></li>
                        </ul>
                    </li>
    ...
    <script>
        ...
        if (currentPage.includes('folha_pagamento')) { $('#submenuFolhaPagamento').addClass('open'); $('#submenuFolhaPagamentoItens').addClass('show'); }
