...
// ==============================================
// BUSCAR TODAS AS TURMAS (sem filtro por professor)
// ==============================================
$sql_turmas = "SELECT DISTINCT t.id, t.nome, t.ano, tr.nome as turno_nome
               FROM turmas t
...
// ==============================================
// BUSCAR TODAS AS DISCIPLINAS (sem filtro por professor)
// ==============================================
$sql_disciplinas = "SELECT d.id, d.nome, d.codigo 
                    FROM disciplinas d
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="turma_id" class="form-select" required>
                                        ...
                                        <option value="<?php echo $turma['id']; ?>"><?php echo $turma['ano'] . 'ª - ' . htmlspecialchars($turma['nome']) . ' (' . ucfirst($turma['turno_nome']) . ')'; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
