...
foreach ($resultados as $resultado) {
    if ($resultado['status'] == 'abandonada') {
        ...
        if ($pior_nota == 0 || $resultado['pontuacao_total'] < $pior_nota) {
...
// Buscar o caminho base para o menu (ajustar conforme necessidade)
$caminho_base = '/sige_Plataforma';
?>
...
<body>
    <?php include __DIR__ . '/includes/menu_professor.php'; ?>
