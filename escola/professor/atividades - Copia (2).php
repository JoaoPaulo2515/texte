...
if (isset($_GET['lancar']) && isset($_GET['id'])) {
    ...
    $stmt_atv = $conn->prepare("SELECT turma_id, disciplina_id, valor_maximo FROM atividades WHERE id = :id AND professor_id = :professor_id");
                ...
                <div class="modal-body">
                    ...
                    <div class="help-step">
                        ...
                        <div class="help-content">
                            ...
                            <p>Clique no botão <strong>"Nova Atividade"</strong> no canto superior direito. Preencha o título, descrição, selecione a turma e disciplina, defina o tipo, valor máximo e data de entrega.</p>
                        </div>
                    </div>
                    ...
                    <div class="help-step">
                        ...
                        <div class="help-content">
                            ...
                            <p>Clique no botão <strong>"Lançar Notas"</strong> no card da atividade. Uma janela abrirá com a lista de alunos da turma. Atribua as notas e salve.</p>
                        </div>
                    </div>
                    ...
                    <div class="help-step">
                        ...
                        <div class="help-content">
                            <h6><i class="fas fa-edit text-primary"></i> Editar Atividade</h6>
                            <p>Para editar uma atividade existente, clique no botão <strong>lápis (✏️)</strong> no card da atividade. Altere as informações necessárias e salve.</p>
                        </div>
                    </div>
                    ...
                    <div class="help-step">
                        ...
                        <div class="help-content">
                            ...
                            <p>Para excluir uma atividade, clique no botão <strong>lixeira (🗑️)</strong> e confirme a exclusão. Atenção: esta ação não pode ser desfeita.</p>
                        </div>
                    </div>
                    ...
                    <div class="help-step">
                        ...
                        <div class="help-content">
                            <h6><i class="fas fa-chart-line text-primary"></i> Acompanhamento</h6>
                            <p>O card da atividade mostra informações importantes: número de lançamentos realizados, data de entrega (com cores indicativas), tipo de atividade e valor máximo.</p>
                        </div>
                    </div>
                    
                    <div class="alert alert-info mt-3">
                        <i class="fas fa-lightbulb"></i>
                        <strong>Dica:</strong> As atividades com data de entrega vencida aparecem em <span class="text-danger">vermelho</span>, as próximas do vencimento em <span class="text-warning">amarelo</span> e as com prazo normal em <span class="text-success">verde</span>.
                    </div>
                    
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle"></i>
                        <strong>Atenção:</strong> Ao lançar notas, elas substituem os lançamentos anteriores para a mesma atividade.
                    </div>
                </div>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Atribua as notas para cada aluno. Deixe em branco para não lançar nota.
                        </div>
