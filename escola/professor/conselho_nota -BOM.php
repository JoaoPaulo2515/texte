...
// ============================================
// FUNÇÃO PARA BUSCAR ALUNOS (CORRIGIDA)
// ============================================
    ...
    <script>
        ...
        function renderizarAlunos(sessaoId) {
            ...
            let filtered = alunos.filter(function(aluno) {
                ...
                let matchStatus = filtroStatus === '' || aluno.status === filtroStatus;
            ...
            for (let aluno of filtered) {
                ...
                let statusClass = aluno.status === 'Aprovado' ? 'badge-aprovado' : (aluno.status === 'Reprovado' ? 'badge-reprovado' : 'badge-recuperacao');
                    ...
                    <div class="aluno-card" onclick="abrirFichaAluno(${aluno.matricula_id})">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <br>
                                <span class="badge ${statusClass}">${aluno.status}</span>
                            </div>
                            <div class="col-auto">
        ...
        function renderizarFicha(data) {
            ...
            for (let disc of data.disciplinas) {
                html += `<tr><td class="fw-bold">${disc.nome}</td>`;
                for (let bim of bimestres) {
