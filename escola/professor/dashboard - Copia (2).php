...
// Total de alunos (soma dos alunos das turmas do professor)
$sql_alunos = "
...
// Próximas aulas (CORRIGIDO - removido pdt.horario)
$sql_proximas_aulas = "
    SELECT DISTINCT 
    ...
    LIMIT 5
";
$stmt_proximas = $conn->prepare($sql_proximas_aulas);
$stmt_proximas->execute([':professor_id' => $professor_id]);
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-white">
                        <h5 class="mb-0"><i class="fas fa-clock"></i> Próximas Aulas</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            ...
                            <div class="aula-card">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <strong><?php echo $aula['turma_ano'] . 'ª ' . htmlspecialchars($aula['turma_nome']); ?></strong>
                                        <br>
                                        <small class="text-muted">
                                            <i class="fas fa-book"></i> <?php echo htmlspecialchars($aula['disciplina_nome']); ?>
                                        </small>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-white">
                        <h5 class="mb-0"><i class="fas fa-clipboard-list"></i> Chamada de Hoje</h5>
                    </div>
                    <div class="card-body text-center">
                        <?php if ($chamada_hoje > 0): ?>
                            <div class="stat-number text-success"><?php echo $chamada_hoje; ?></div>
                            <p class="text-muted">registros de chamada realizados hoje</p>
                            <a href="registrar_chamada.php" class="btn btn-primary mt-2">
                                <i class="fas fa-plus"></i> Continuar Chamada
                            </a>
                        <?php else: ?>
                            <div class="stat-number text-muted">0</div>
                            <p class="text-muted">Nenhuma chamada registrada hoje</p>
                            <a href="registrar_chamada.php" class="btn btn-primary mt-2">
                                <i class="fas fa-clipboard-list"></i> Registrar Chamada
                            </a>
                        <?php endif; ?>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-white">
                        <h5 class="mb-0"><i class="fas fa-link"></i> Acessos Rápidos</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <a href="conselho_nota.php" class="text-decoration-none">
                                    <i class="fas fa-chalkboard-user"></i> Conselho de Nota
                                </a>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <a href="proposta_prova.php" class="text-decoration-none">
                                    <i class="fas fa-file-alt"></i> Proposta de Prova
                                </a>
                            </div>
                        </div>
