...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ESTILO PARA O ENUNCIADO HTML - PRESERVA A FORMATAÇÃO ORIGINAL */
        .questao-enunciado {
            font-size: 1rem;
            line-height: 1.7;
            color: #2c3e50;
        ...
        /* Estilos para elementos HTML dentro do enunciado */
        .questao-enunciado p {
            margin-bottom: 12px;
        }
        
        .questao-enunciado p:last-child {
            margin-bottom: 0;
        }
        
        .questao-enunciado strong, .questao-enunciado b {
            font-weight: 700;
            color: #1A2A6C;
        }
        
        .questao-enunciado em, .questao-enunciado i {
            font-style: italic;
        }
        ...
        .questao-enunciado h1, .questao-enunciado h2, .questao-enunciado h3 {
            margin-top: 15px;
            margin-bottom: 10px;
            font-weight: 600;
        }
        
        .questao-enunciado h1 { font-size: 1.6rem; }
        .questao-enunciado h2 { font-size: 1.4rem; }
        .questao-enunciado h3 { font-size: 1.2rem; }
        
        .questao-enunciado ul, .questao-enunciado ol {
            margin: 10px 0;
            padding-left: 25px;
        }
        
        .questao-enunciado li {
            margin-bottom: 5px;
        }
        
        .questao-enunciado table {
            width: 100%;
            border-collapse: collapse;
            margin: 15px 0;
        }
        
        .questao-enunciado th, .questao-enunciado td {
            border: 1px solid #ddd;
            padding: 8px;
            text-align: left;
        }
        
        .questao-enunciado th {
            background: #f2f2f2;
        }
        ...
        .questao-enunciado .math-display {
            background: #f8f9fa;
            padding: 15px;
            border-radius: 8px;
            text-align: center;
            ...
            <?php else: ?>
                ...
                <div class="questao-card" style="animation-delay: <?php echo $index * 0.08; ?>s">
                    ...
                    <div class="questao-body">
                        <!-- EXIBIR ENUNCIADO EM HTML PURO - PRESERVA FORMATAÇÃO ORIGINAL -->
                        <div class="questao-enunciado">
                            <?php 
                            // Exibe o HTML diretamente, preservando toda formatação do editor rich text
                            // Isso mantém negrito, itálico, listas, tabelas, imagens, etc.
                        ...
                        <?php elseif ($questao['tipo'] == 'dissertativa'): ?>
                            <div class="alert-dissertativa">
                                ...
                                <div class="mt-3">
                                    ...
                                    <?php if (!empty($questao['gabarito'])): ?>
                                        <div class="bg-white p-3 rounded mt-1" style="border-left: 3px solid #28a745;">
                                            <?php echo nl2br(htmlspecialchars($questao['gabarito'])); ?>
                                        </div>
                                    <?php else: ?>
