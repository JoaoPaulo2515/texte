...
if (isset($_GET['lancar']) && isset($_GET['id'])) {
    ...
    if ($atividade_lancar) {
        ...
        // Buscar notas já existentes na tabela NOTAS (campo MAC)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] == 'lancar_notas') {
    ...
    // Buscar dados da atividade
    $stmt_atv = $conn->prepare("
        SELECT turma_id, disciplina_id, bimestre, valor_maximo 
        FROM atividades 
        WHERE id = :id AND professor_id = :professor_id
    ");
        ...
        try {
            ...
            foreach ($_POST['nota'] as $estudante_id => $nota) {
                if ($nota !== '') {
                    ...
                    // Calcular média de todas as atividades do bimestre
                    ...
                    // Verificar se já existe registro na tabela notas
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Atenção:</strong> As atividades com data de entrega vencida aparecem em <span class="text-danger">vermelho</span>, as próximas do vencimento em <span class="text-warning">amarelo</span> e as com prazo normal em <span class="text-success">verde</span>.
                    </div>
                </div>
