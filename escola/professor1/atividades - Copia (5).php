...
function detectarBimestreAtual($data_atual, $ano_letivo) {
    // Se tiver datas definidas no ano letivo
...
if (isset($_GET['lancar']) && isset($_GET['id'])) {
    ...
    if ($atividade_lancar) {
        // Verificar se ainda pode lançar notas (2 dias após a data de entrega)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] == 'lancar_notas') {
    ...
    if ($atv) {
        // Verificar se ainda pode lançar notas
