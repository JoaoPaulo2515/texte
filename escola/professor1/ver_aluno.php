            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <p class="mb-0">
                        ...
                        <i class="fas fa-venus-mars"></i> <?php echo $aluno['genero'] == 'M' ? 'Masculino' : 'Feminino'; ?>
                    </p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card info-card">
                    ...
                    <div class="card-body">
                        <p><i class="fas fa-envelope"></i> <strong>Email:</strong><br> <?php echo htmlspecialchars($aluno['email']) ?: 'Não informado'; ?></p>
                        <p><i class="fas fa-phone"></i> <strong>Telefone:</strong><br> <?php echo htmlspecialchars($aluno['telefone']) ?: 'Não informado'; ?></p>
                        <p><i class="fas fa-map-marker-alt"></i> <strong>Endereço:</strong><br> <?php echo htmlspecialchars($aluno['endereco']) ?: 'Não informado'; ?></p>
                    </div>
                </div>
                ...
                <div class="card info-card">
                    ...
                    <div class="card-body">
                        <p><i class="fas fa-id-card"></i> <strong>BI/CPF:</strong><br> <?php echo htmlspecialchars($aluno['cpf'] ?? $aluno['bi'] ?? 'Não informado'); ?></p>
                        <p><i class="fas fa-calendar"></i> <strong>Data de Nascimento:</strong><br> <?php echo formatarData($aluno['data_nascimento']); ?></p>
                        <p><i class="fas fa-map-marker"></i> <strong>Naturalidade:</strong><br> <?php echo htmlspecialchars($aluno['naturalidade'] ?? 'Não informado'); ?></p>
                    </div>
                </div>
