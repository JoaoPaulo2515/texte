<?php
// escola/relatorios/boletim_nota.php - Boletim de Notas do Aluno
...
<head>
    ...
    <title>Boletim de Notas | SIGE Angola</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-graduation-cap"></i> Boletim de Notas</h2>
            <div class="no-print">
        ...
        <div class="boletim-header">
            <div class="text-center">
                ...
                <p><?php echo $anos_letivos[array_search($ano_letivo_id, array_column($anos_letivos, 'id'))]['ano']; ?></p>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="nota-cell">
                            <?php
                            if ($disciplina['is_exame_classe'] && $disciplina['is_linguagem']) {
                                echo $nota3['exame_oral'] !== null ? number_format($nota3['exame_oral'], 1, ',', '.') : '---';
                            } elseif ($disciplina['is_exame_classe']) {
        ...
        <?php elseif ($turma_id == 0): ?>
            <div class="alert alert-secondary text-center">
                <i class="fas fa-filter"></i> Selecione uma turma e um aluno para visualizar o boletim.
            </div>
        <?php endif; ?>
    </div>
