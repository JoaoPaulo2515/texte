<?php
// escola/turmas/cadastrar.php - Cadastro de Turmas
    ...
    if (empty($nome) || empty($ano) || empty($turno)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("
                ...
                WHERE escola_id = :escola_id AND nome = :nome AND ano_letivo = :ano_letivo
            ");
            $stmt->execute([
                ':escola_id' => $escola_id,
                ':nome' => $nome,
            ...
            $stmt = $conn->prepare("
                INSERT INTO turmas (escola_id, nome, ano, turno, ano_letivo, capacidade, sala, status, created_at)
                VALUES (:escola_id, :nome, :ano, :turno, :ano_letivo, :capacidade, :sala, :status, NOW())
            ");
            ...
            $stmt = $conn->prepare("
                ...
                VALUES (:usuario_id, 'cadastrar_turma', 'turmas', :registro_id, :ip, NOW())
            ");
            $stmt->execute([
            ...
            <div class="card-body">
                ...
                <form method="POST" id="formTurma">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nome" class="form-control" placeholder="Ex: 10ª A, Turma A, etc." required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" name="capacidade" class="form-control" value="30" min="1" max="100">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Informação:</strong> Após criar a turma, poderá matricular alunos e atribuir professores às disciplinas.
                    </div>
