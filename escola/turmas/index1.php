...
$query = "
    SELECT t.*, 
           ...
           (SELECT COUNT(*) FROM alocacoes WHERE turma_id = t.id) as total_professores
    FROM turmas t
...
<head>
    ...
    <style>
        ...
        .turma-card { transition: transform 0.3s; cursor: pointer; }
            ...
            <div class="col-md-4 mb-4">
                <div class="card turma-card" onclick="location.href='visualizar.php?id=<?php echo $turma['id']; ?>'">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted"><?php echo $turma['ano']; ?> - Turno: <?php echo ucfirst($turma['turno']); ?></p>
                        <hr>
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="mt-2">
                            <span class="status-badge status-<?php echo $turma['status']; ?>"><?php echo ucfirst($turma['status']); ?></span>
                        </div>
                    </div>
