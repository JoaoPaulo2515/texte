...
<head>
    ...
    <style>
        ...
        .notification-item { border-left: 3px solid; margin-bottom: 10px; transition: all 0.3s; }
        .notification-item:hover { background: #f8f9fa; }
        .notification-nao_lida { border-left-color: #006B3E; background: #f0fdf4; }
        .notification-lida { border-left-color: #ccc; opacity: 0.7; }
