...
<head>
    ...
    <style>
        ...
        .ticket-item { border-left: 4px solid; transition: all 0.3s; cursor: pointer; }
        ...
        .message-bubble { background: #f0f2f5; border-radius: 15px; padding: 15px; margin-bottom: 15px; }
        .message-bubble.admin { background: #e3f2fd; border-left: 4px solid #1565c0; }
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr><td colspan="8" class="text-center">Nenhum ticket encontrado</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
