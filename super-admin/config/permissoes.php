...
<body>
    ...
    <div class="main-content">
            ...
            <div class="card-body">
                <form method="GET" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <label>&nbsp;</label>
                            <div><button type="submit" class="btn btn-primary">Carregar Permissões</button></div>
                        </div>
                    </div>
                </form>
                ...
                <form method="POST">
                    ...
                    <div class="perm-group">
                        <h5><i class="fas fa-folder-open"></i> <?php echo ucfirst($modulo); ?> <small class="text-muted float-end"><a href="#" onclick="selectModule('<?php echo $modulo; ?>', true); return false;">Selecionar</a> | <a href="#" onclick="selectModule('<?php echo $modulo; ?>', false); return false;">Desmarcar</a></small></h5>
                        <div class="row">
                            <?php foreach ($modulo_permissoes as $permissao): ?>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="permissoes[]" value="<?php echo $permissao['id']; ?>" class="form-check-input permissao-checkbox modulo-<?php echo $modulo; ?>" id="perm_<?php echo $permissao['id']; ?>" <?php echo in_array($permissao['id'], $permissoes_atuais) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="perm_<?php echo $permissao['id']; ?>"><?php echo htmlspecialchars($permissao['descricao']); ?><br><small class="text-muted"><?php echo $permissao['nome']; ?></small></label>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="salvar_permissoes" class="btn btn-primary btn-lg px-5"><i class="fas fa-save"></i> Salvar Permissões</button>
                    </div>
                </form>
                <?php endif; ?>
            </div>
        ...
        <div class="card">
            <div class="card-header"><h3 class="mb-0"><i class="fas fa-info-circle"></i> Sobre Permissões</h3></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6"><h6><i class="fas fa-check-circle text-success"></i> Como funciona?</h6><p>As permissões controlam o acesso dos usuários às funcionalidades do sistema. Cada papel pode ter diferentes níveis de acesso.</p>
                    <h6 class="mt-3"><i class="fas fa-tag text-info"></i> Tipos de Papéis</h6>
                    <ul><li><strong>Super Administrador</strong> - Acesso total a todas as funcionalidades</li><li><strong>Administrador Escola</strong> - Gerencia todas as funcionalidades da escola</li><li><strong>Diretor</strong> - Gerencia a escola e visualiza relatórios</li><li><strong>Professor</strong> - Lança notas e faz chamada</li><li><strong>Secretaria</strong> - Gerencia matrículas e documentos</li><li><strong>Aluno</strong> - Visualiza notas e frequência</li><li><strong>Pai/Encarregado</strong> - Acompanha o desempenho do aluno</li></ul></div>
                    <div class="col-md-6"><h6><i class="fas fa-shield-alt text-warning"></i> Dicas de Segurança</h6><ul><li>Conceda apenas as permissões necessárias para cada papel</li><li>Revise as permissões periodicamente</li><li>O papel de Super Administrador deve ter acesso total</li><li>Alunos e Pais devem ter acesso apenas a visualização</li></ul>
                    <h6 class="mt-3"><i class="fas fa-chart-line text-primary"></i> Módulos Disponíveis</h6>
                    <ul><li><strong>Dashboard</strong> - Painel de controle e estatísticas</li><li><strong>Escolas</strong> - Gestão de escolas cadastradas</li><li><strong>Planos</strong> - Configuração de planos e preços</li><li><strong>Assinaturas</strong> - Controle de assinaturas</li><li><strong>Pagamentos</strong> - Gestão financeira</li><li><strong>Comunicação</strong> - Tickets e notificações</li><li><strong>Relatórios</strong> - Relatórios e estatísticas</li><li><strong>Configurações</strong> - Configurações do sistema</li></ul></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function toggleAll(checked) { $('.permissao-checkbox').prop('checked', checked); }
        function selectModule(module, checked) { $('.modulo-' + module).prop('checked', checked); }
