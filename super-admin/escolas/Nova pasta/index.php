...
<head>
    ...
    <style>
        ...
        .top-bar { background: white; border-radius: 10px; padding: 15px 20px; margin-bottom: 20px; display: flex; justify-content: space-between; }
        .card { background: white; border-radius: 15px; margin-bottom: 20px; border: none; }
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <a href="cadastrar.php" class="btn btn-primary"><i class="fas fa-plus"></i> Nova Escola</a>
        </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <?php if ($escola['logo']): ?>
                                        <img src="../../uploads/escolas/<?php echo $escola['logo']; ?>" class="logo-preview">
                                    <?php else: ?>
