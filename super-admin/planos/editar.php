<?php
// super-admin/planos/editar.php - Editar plano
...
$modulos_ativos = json_decode($plano['modulos_disponiveis'], true) ?: [];
...
<head>
    ...
    <title>Editar Plano - <?php echo htmlspecialchars($plano['nome']); ?> | SIGE Angola</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <h2><i class="fas fa-edit"></i> Editar Plano: <?php echo htmlspecialchars($plano['nome']); ?></h2>
            ...
            <div class="card-body">
                ...
                <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="modulos[]" value="<?php echo $key; ?>" class="form-check-input" <?php echo in_array($key, $modulos_ativos) ? 'checked' : ''; ?>>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        As alterações afetarão apenas novas assinaturas. Assinaturas existentes manterão o plano original.
                    </div>
